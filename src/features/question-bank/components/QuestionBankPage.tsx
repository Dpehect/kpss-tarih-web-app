        ...
        {topics.map((topic, index) => {
          ...
          return (
            <a
              ...
              className="group relative overflow-hidden rounded-[2rem] border border-black/[0.08] bg-[#fffaf0]/78 p-6 shadow-[0_20px_70px_rgba(18,24,38,0.08)] transition hover:-translate-y-1 hover:bg-white hover:shadow-[0_28px_90px_rgba(18,24,38,0.13)]"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between gap-4">
                  <span className="grid size-12 place-items-center rounded-2xl bg-[#111827] text-[#fffaf0]">
                    <FileQuestion size={20} />
                  </span>
                  <span className="rounded-full border border-black/[0.08] bg-white/60 px-3 py-1 text-xs font-black text-[#425066]">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                </div>

                <h2 className="mt-6 text-2xl font-black tracking-[-0.05em]">{topic.title}</h2>
                ...
                <div className="mt-6 flex items-center justify-between border-t border-black/[0.08] pt-4">
                  <span className="text-sm font-black text-[#111827]">Teste gir</span>
