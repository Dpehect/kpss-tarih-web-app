        ...
        <div className="bureau-card rounded-[2rem] p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="mt-1 text-2xl font-black tracking-[-0.05em] text-[var(--bureau-ink)]">Canlı durum</h3>
            </div>
          </div>

          <div className="mt-5 grid grid-cols-3 gap-2">
            <MiniStat label="Doğru" value={correctCount} tone="teal" />
            <MiniStat label="Yanlış" value={wrongCount} tone="rust" />
            <MiniStat label="Cevap" value={answeredCount} tone="blue" />
          </div>
        ...
        <div className="bureau-card rounded-[2rem] p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="mt-1 text-2xl font-black tracking-[-0.05em] text-[var(--bureau-ink)]">Kayıt izi</h3>
            </div>
          </div>
            ...
            {questionNumbers.map((item) => {
              ...
              return (
                <button
                  ...
                  data-dark-button={isCurrent ? "true" : undefined}
...
function MiniStat({ label, value, tone }: { label: string; value: number; tone: "teal" | "rust" | "blue" }) {
  const toneClass = {
  ...
  return (
    <div className="rounded-[1rem] border border-[var(--bureau-line)] bg-[rgba(255,250,242,.72)] p-3">
      ...
      <p className={`mt-2 rounded-xl px-2 py-1 text-center text-xl font-black ${toneClass}`}>{value}</p>
    </div>
  );
}
