    ...
    <html lang="tr">
      <body>
        <main className="grid min-h-screen place-items-center bg-[var(--bg)] p-6 text-[var(--navy-900)]">
          <section className="w-full max-w-2xl rounded-[2.5rem] border border-[var(--border-soft)] bg-[rgba(255,248,234,.92)] p-8 text-center shadow-[var(--shadow-lg)] backdrop-blur-2xl">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm font-semibold leading-7 text-[var(--text-secondary)]">
              Sayfayı yenileyebilir veya tekrar deneyebilirsin. Bu ekran kullanıcıyı boş hata sayfasına düşürmemek için tasarlandı.
            </p>
            {error?.digest ? (
