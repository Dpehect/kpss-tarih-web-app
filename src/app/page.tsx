        ...
        <div className="mx-auto flex min-h-[78px] w-full max-w-7xl items-center justify-between px-5 md:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <ButtonLink
              ...
              variant="primary"
              size="md"
              className="rounded-2xl bg-[#101828] px-5 text-white hover:bg-[#1d2939]"
            >
              Başla
            </ButtonLink>
          </div>
        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <ButtonLink
              ...
              variant="primary"
              size="lg"
              className="min-h-14 rounded-2xl bg-[#b4232a] px-7 text-base text-white shadow-[0_24px_70px_rgba(180,35,42,.22)] hover:bg-[#9f1f26]"
            >
              <Play size={18} />
              Hızlı Test Aç
            </ButtonLink>
